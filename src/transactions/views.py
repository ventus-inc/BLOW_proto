...
class SendTransactionView(View):
    ...
    def post(self, request, *args, **kwargs):
        if request.method == 'POST':
            ...
            web3.personal.signAndSendTransaction(formatters.input_transaction_formatter(web3.eth, {
                                                 'to': to_wallet.num, 'from': from_wallet.num, 'value': value}), request.user.username)
